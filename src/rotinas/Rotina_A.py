...
def executar_rotina_A(matricula, senha, data):
    ...
    robo.digitar_texto("texto", 4, 16)

    print("Filial preenchida com sucesso")
    robo.digitar_texto("texto", 4, 31)
    robo.digitar_texto("texto", 4, 38)
    robo.digitar_texto("texto", 4, 51)
    ...
    robo.digitar_texto("texto", 7, 13)
    robo.digitar_texto("texto", 21, 3)
    ...
    robo.digitar_texto("texto", 9, 7)
    robo.enviar_tecla("[enter]")
    robo.aguardar_pronto()

    robo.digitar_texto("texto", 4, 11)
    robo.enviar_tecla("[enter]")
    robo.aguardar_pronto()

    robo.digitar_texto("texto", 3, 49)
    robo.enviar_tecla("[enter]")
    robo.aguardar_pronto()
...
if __name__ == "__main__":
    ...
    executar_rotina_A("12345678", "senha_teste", "01012026")
